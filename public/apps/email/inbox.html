                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-email" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-email">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-email">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="../../apps/email/inbox.html" data-bs-toggle="" aria-expanded="false">
            ...
            <div class="col-lg">
              <div class="px-lg-1">
                <div class="d-flex align-items-center flex-wrap position-sticky pb-2 bg-soft z-index-2 email-toolbar inbox-toolbar">
                  ...
                  <div class="d-flex">
                    <p class="text-600 fs--1 fw-semi-bold mb-0 me-3">Showing : <span class="text-900">1-7 </span>of <span class="text-900">205</span></p>
