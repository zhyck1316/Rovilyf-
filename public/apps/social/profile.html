        ...
        <div class="pb-9">
            ...
            <div class="card-header hover-actions-trigger d-flex justify-content-center align-items-end position-relative mb-7 mb-xxl-0" style="min-height: 214px; ">
              ...
              <div class="hoverbox feed-profile" style="width: 150px; height: 150px">
                ...
                <div class="position-relative bg-400 rounded-circle cursor-pointer d-flex flex-center mb-xxl-7">
                  <div class="avatar avatar-5xl"><img class="rounded-circle rounded-circle bg-white img-thumbnail shadow-sm" src="../../assets/img/team/9.webp" alt="" /></div>
                ...
                <div class="col-auto">
                  ...
                  <div class="mb-5">
                    <div class="d-md-flex align-items-center">
                      <div class="d-flex align-items-center"><span class="fa-solid fa-user-group fs--1 text-700 me-2 me-lg-1 me-xl-2"></span><a class="text-1100" href="#!"><span class="fs-1 fw-bold text-600 hover-text-1100">1297 <span class="fw-semi-bold ms-1 me-4">Followers</span></span></a></div>
                      <div class="d-flex align-items-center"><span class="fa-solid fa-user-check fs--1 text-700 me-2 me-lg-1 me-xl-2"></span><a class="text-1100" href="#!"><span class="fs-1 fw-bold text-600 hover-text-1100">3971 <span class="fw-semi-bold ms-1 me-4">Following</span></span></a></div>
                      <div class="d-flex align-items-center"><span class="fa-solid fa-location-dot fs--1 text-700 me-2 me-lg-1 me-xl-2"></span><a class="text-1100" href="#!"><span class="fs-1 fw-semi-bold text-600 hover-text-1100">Vancouver, Lothal</span></a></div>
                    </div>
                  </div>
                ...
                <div class="col-auto">
                  <div class="row g-2">
                    <div class="col-auto order-xxl-2">
                      <button class="btn btn-primary lh-1"><span class="fa-solid fa-user-plus me-2"></span>Follow Request</button>
                    </div>
          ...
          <div class="row gy-3 gx-5 gx-xxl-6">
            <div class="col-xl-4 d-none d-xl-block">
              <div class="mb-8">
                <div class="row g-0">
                  <div class="col-6 border-1 border-bottom border-end py-2"> <a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex flex-column d-xxl-inline-block" href="#!"><span class="fa-solid fa-user-group me-2 mb-2 mb-xxl-0"></span>Followers</a></div>
                  <div class="col-6 border-1 border-bottom py-2"><a class="btn btn-link fs-0 text-800 hover-primary fw-semi-bold d-flex flex-column d-xxl-inline-block" href="#!"><span class="fa-solid fa-users me-2 mb-2 mb-xxl-0"></span>Communities</a></div>
                  <div class="col-6 border-1 border-bottom border-end py-2"><a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex flex-column d-xxl-inline-block" href="#!"><span class="fa-solid fa-photo-film me-2 mb-2 mb-xxl-0"></span>Media Files</a></div>
                  <div class="col-6 border-1 border-bottom py-2"><a class="btn btn-link fs-0 text-800 hover-primary fw-semi-bold d-flex flex-column d-xxl-inline-block" href="#!"><span class="fa-solid fa-calendar-days me-2 mb-2 mb-xxl-0"></span>Events</a></div>
                  <div class="col-6 border-1 border-end py-2"><a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex flex-column d-xxl-inline-block" href="#!"><span class="fa-solid fa-dice me-2 mb-2 mb-xxl-0"></span>Games</a></div>
                  <div class="col-6 border-1 py-2"><a class="btn btn-link fs-0 text-800 hover-primary fw-semi-bold d-flex flex-column d-xxl-inline-block" href="#!"><span class="fa-solid fa-user-gear me-2 mb-2 mb-xxl-0"></span>Settings </a></div>
                </div>
              </div>
              <div class="mb-8">
                <div class="d-flex pb-4 align-items-end">
                  <h3 class="flex-1 mb-0">Photos</h3><a class="fw-bold fs--1 me-4" href="#!">Albums</a><a class="fw-bold fs--1" href="#!">See all</a>
                </div>
                <div class="row g-3">
              ...
              <div class="d-flex pb-4 align-items-end border-bottom border-dashed">
                <h3 class="flex-1 mb-0">You and Erza</h3><a class="fw-bold fs--1" href="#!">See details</a>
              </div>
              <div class="row g-0 mb-5 mb-lg-0">
                <div class="col-12 border-1 border-bottom py-2"><a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex" href="#!"><span class="fa-solid fa-user-group me-2 mb-2 mb-xxl-0"></span>432 Common Followers</a></div>
                <div class="col-12 border-1 border-bottom py-2"><a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex" href="#!"><span class="fa-solid fa-users me-2 mb-2 mb-xxl-0"></span>21 Communities</a></div>
                <div class="col-12 border-1 border-bottom py-2"><a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex" href="#!"><span class="fa-solid fa-tags me-2 mb-2 mb-xxl-0"></span>12 Tagged Images</a></div>
                <div class="col-12 border-1 border-bottom py-2"><a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex" href="#!"><span class="fa-solid fa-calendar-days me-2 mb-2 mb-xxl-0"></span>3 Common Events</a></div>
                <div class="col-12 border-1 border-bottom py-2"><a class="btn btn-link ps-2 fs-0 text-800 hover-primary fw-semi-bold d-flex" href="#!"><span class="fa-solid fa-location-dot me-2 mb-2 mb-xxl-0"></span>45 Common Check-ins</a></div>
              </div>
            </div>
                    ...
                    <div class="card-body p-3 p-sm-4">
                      <div class="border-bottom mb-3">
                        <div class="d-flex align-items-center mb-3"><a href="../../apps/social/profile.html">
                          ...
                          <div class="flex-1"><a class="fw-bold mb-0 text-black" href="../../apps/social/profile.html">Erza Bridgest</a>
                            <p class="fs--2 mb-0 text-600 fw-semi-bold">35 mins ago<span class="fa-solid fa-circle text-300" data-fa-transform="shrink-10 down-2"></span>Mustafar, British Columbia<span class="fa-solid fa-circle text-300" data-fa-transform="shrink-10 down-2"></span><span class="fa-solid fa-earth-americas text-900"></span>
                            </p>
                          </div>
                    ...
                    <div class="card-body p-3 p-sm-4">
                      <div class="border-bottom mb-3">
                        <div class="d-flex align-items-center mb-3"><a href="../../apps/social/profile.html">
                          ...
                          <div class="flex-1"><a class="fw-bold mb-0 text-black" href="../../apps/social/profile.html">Erza Bridgest</a>
                            <p class="fs--2 mb-0 text-600 fw-semi-bold">3 days ago<span class="fa-solid fa-circle text-300" data-fa-transform="shrink-10 down-2"></span>Lothal, USA<span class="fa-solid fa-circle text-300" data-fa-transform="shrink-10 down-2"></span><span class="fa-solid fa-earth-americas text-900"></span>
                            </p>
                          </div>
                          <div class="btn-reveal-trigger">
                            <button class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none d-flex btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h"></span></button>
                      ...
                      <div class="d-flex">
                        <button class="btn btn-link p-0 me-3 fs--2 fw-bolder" type="button"><span class="fa-solid fa-heart me-1"></span>23 Likes
                        </button>
                        <button class="btn btn-link text-900 p-0 fs--2 me-3 fw-bolder" type="button"><span class="fa-solid fa-comment me-1"></span>9 Comments
                        </button>
                        <button class="btn btn-link text-900 p-0 fs--2 me-2 fw-bolder" type="button"><span class="fa-solid fa-share me-1"></span>3 shares
                        </button>
                      </div>
                    </div>
                    <div class="bg-100 border-top p-3 p-sm-4">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="bg-100 border-top p-3 p-sm-4">
                      <div class="d-flex align-items-start"><a href="../../apps/social/profile.html">
                        ...
                        <div class="flex-1">
                          <div class="d-flex align-items-center"><a class="fw-bold mb-0 text-black" href="../../apps/social/profile.html">Sutanuka Gomez</a><span class="text-600 fw-semi-bold fs--2 ms-2">35 mins ago</span></div>
                          <p class="mb-0">Time is the best teacher; Unfortunately it kills all its students!</p>
                          <button class="btn btn-link p-0 text-900 fw-bolder mb-2" type="button"><span class="fa-solid fa-reply fs--2 me-1"></span><span class="fw-bold fs--2">Reply</span></button>
                          <div class="d-flex align-items-start mb-3"><a href="../../apps/social/profile.html">
                              <div class="avatar avatar-m  me-2">
