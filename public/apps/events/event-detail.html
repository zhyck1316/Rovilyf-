  ...
  <body>
    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-events" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-events">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-events">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="../../apps/events/event-detail.html" data-bs-toggle="" aria-expanded="false">
      ...
      <div class="content">
        ...
        <div class="pb-9">
          <h2 class="mb-4 mb-lg-6">Event details</h2><img class="rounded w-100 fit-cover mb-5 mb-md-6 mb-xl-8" src="../../assets/img/generic/34.png" alt="" style="min-height: 250px;" />
          <div class="row gx-lg-9">
            <div class="col-xl-8 border-end-xl border-300">
              <div class="card mb-9">
                <div class="card-body">
                  <h1 class="lh-sm fs-2 fs-xxl-4 mb-2">Brandmyth presents- Shironamhin 25 years celebration with symphony orchestra</h1>
                  <p class="fs-0 mb-4 text-600">Tavern on the Greend, New York</p>
                    ...
                    <div class="card-body">
                      <div class="row gy-5">
                          ...
                          <div>
                            <div class="mb-3">
                              <div class="d-flex align-items-center">
                                ...
                                <h5 class="ms-2 text-1100 mb-0">Location</h5>
                              </div>
                            </div>
                            <p class="lh-sm mb-0 text-700">36/4A, James Tiberius Auditorium,<br />Vancouver, British Columbia, Canada </p>
                          </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <p class="lh-sm mb-0 text-700">28th June - 2nd July 2022,<br />10 am - 4 pm Eastern Daylight Time</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row g-1 g-sm-2 mb-7 mb-xxl-8">
                <div class="col-3"><a href="../../assets/img/gallery/19.jpg" data-gallery="gallery-posts-undefined"><img class="rounded h-100 w-100 fit-cover" src="../../assets/img/gallery/19.jpg" alt="..." /></a></div>
                <div class="col-3"><a href="../../assets/img/gallery/20.jpg" data-gallery="gallery-posts-undefined"><img class="rounded h-100 w-100 fit-cover" src="../../assets/img/gallery/20.jpg" alt="..." /></a></div>
                <div class="col-6"><a href="../../assets/img/gallery/21.jpg" data-gallery="gallery-posts-undefined"><img class="rounded h-100 w-100 fit-cover" src="../../assets/img/gallery/21.jpg" alt="..." /></a></div>
              </div>
              <h4 class="mb-3 text-1000 fs-xxl-2">Topic To Be Covered:</h4>
              <ul class="mb-6 ps-4">
              ...
              <h4 class="mb-3 text-1000 fs-xxl-2">Refund Policy:</h4>
              <ul class="mb-6 ps-4">
                <li>Contact the organizer to request a refund.</li>
                <li>Eventbrite's fee is nonrefundable.</li>
              </ul>
              <h3 class="mb-3 fw-bold text-1000 fs-1 fs-xxl-2">Responses:</h3>
              <div class="d-flex mb-6">
                <div class="me-3">
                  <p class="mb-2 text-800">Going</p>
                  <h3 class="text-800">4,569</h3>
                </div>
                <div class="my-3 mx-2 mx-sm-3 border-start"></div>
                <div class="mx-3">
                  <p class="mb-2 text-800">Interested</p>
                  <h3 class="text-800">15,652</h3>
                </div>
                <div class="my-3 mx-2 mx-sm-3 border-start"></div>
                <div class="ms-3">
                  <p class="mb-2 text-800">Share</p>
                  <h3 class="text-800">11,236</h3>
                </div>
              </div>
              <h3 class="mb-3 fw-bold text-1000 fs-1">Share with Friends:</h3>
              <div class="d-flex mb-5">
                <button class="btn btn-phoenix-primary btn-icon me-2"><span class="fa-brands fa-facebook text-facebbok"></span></button>
              ...
              <button class="btn btn-phoenix-primary w-100 mb-5 mb-xl-0" type="button">Load more</button>
            </div>
            <div class="col-xl-4">
              ...
              <div class="row g-2 mb-6 align-items-center">
                ...
                <div class="col-sm-auto flex-1"><a class="mb-0 text-primary fw-semi-bold lh-sm" href="#!">Bass Events, Inc.</a></div>
                <div class="col-sm-auto col-xl-12 col-xxl-auto">
                  <button class="btn btn-link text-900 p-0 me-1" type="button">10k Followers </button>
              ...
              <div class="mb-8">
                ...
                <div class="row flex-between-center g-0 gy-3">
                  <div class="col-12 col-sm-auto me-1">
                    <div class="d-flex">
                      <h3 class="fw-bold text-1000 fs-0 me-2 mb-0">James Tiberius Auditorium</h3>
                      <p class="mb-0 text-1000 fs--1">Vancouver</p>
                    </div>
                  </div>
                  <div class="col-12 col-sm-auto col-xl-12">
                    <button class="btn btn-phoenix-primary w-100" type="button"><span class="fa-solid fa-route me-2"></span>Get directions</button>
                  </div>
                </div>
              </div>
              <h3 class="mb-3">Tags</h3>
              <div class="d-flex flex-wrap pb-7 border-bottom"><span class="badge badge-tag me-2 mb-2">Music</span><span class="badge badge-tag me-2 mb-2">CONCERT</span><span class="badge badge-tag mb-2">Greatest show on earth</span></div>
              <div class="row g-0 py-3 border-bottom border-dashed border-300 align-items-end justify-content-between">
                ...
                <div class="col-auto"><a class="fw-bold fs--1" href="#!">See more</a></div>
              </div>
              <div class="py-3 border-bottom border-dashed">
                ...
                </div><a class="hover-primary text-1000 fw-bold mb-2 line-clamp-1 me-5 lh-base" href="#!">Master Class on FILM Studies THESIS on Makers</a>
                <p class="text-800 fs--1 mb-2">Organized by <br /><a class="fw-bold text-primary" href="#!">IAFM- International Academy of Film and Media</a></p>
              ...
              <div class="py-3 border-bottom border-dashed">
                ...
                </div><a class="hover-primary text-1000 fw-bold mb-2 line-clamp-1 me-5 lh-base" href="#!">Master Class on FILM Studies 'ANALYSIS of Cinema'</a>
                <p class="text-800 fs--1 mb-2">Organized by <br /><a class="fw-bold text-primary" href="#!">IAFM- International Academy of Film and Media</a></p>
                <p class="fs--2 text-600">64 people going</p>
                <p class="fs--1 text-700 fw-bold mb-1"><span class="fa-solid fa-clock text-800 me-1"></span>12.30PM - 10PM</p>
                <p class="fs--1 text-700 fw-bold mb-0"><span class="fa-solid fa-map-marker-alt text-800 me-1"></span>Tavern on the Greend, New York</p>
              ...
              <div class="py-3 border-bottom border-dashed">
                ...
                </div><a class="hover-primary text-1000 fw-bold mb-2 line-clamp-1 me-5 lh-base" href="#!">Witnessing History in Making Photographs</a>
                <p class="text-800 fs--1 mb-2">Organized by <br /><a class="fw-bold text-primary" href="#!">IAFM- International Academy of Film and Media</a></p>
                <p class="fs--2 text-600">64 people going</p>
                <p class="fs--1 text-700 fw-bold mb-1"><span class="fa-solid fa-clock text-800 me-1"></span>12.30PM - 10PM</p>
                <p class="fs--1 text-700 fw-bold mb-0"><span class="fa-solid fa-map-marker-alt text-800 me-1"></span>Tavern on the Greend, New York</p>
